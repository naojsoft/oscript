...
from oscript.DotParaFiles.DotParaFileParser import (ParameterValidationException,
                                                    ParameterHandler,
...
class QuatedListTestCase(unittest.TestCase):
    ...
    def testParse(self):
        ...
        paramDefs = paramObj.paramDict
        ex = paramDefs['SELECT']
        logger.debug(repr(ex.getParamDefForParamMap()['SET']))
