...
class ParaValidator(object):
    ...
    def keys(self):
        ...
        """
        return list(self.para.keys())


    def items(self):
        """Return all the items for all loaded PARA definitions.
        """
        return list(self.para.items())
    ...
    def processCmd(self, cmdstr, noparaok=False):
        ...
        except CommandParser.CommandParserError as e:
